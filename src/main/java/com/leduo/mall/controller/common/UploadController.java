 ...
 * 版权所有，侵权必究！
 */
package com.leduo.mall.controller.common;

import com.leduo.mall.common.Constants;
import com.leduo.mall.util.LeDuoMallUtils;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        try {
            ...
            resultSuccess.setData(LeDuoMallUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
    ...
    public Result uploadV2(HttpServletRequest httpServletRequest) throws URISyntaxException {
        ...
        for (int i = 0; i < multipartFiles.size(); i++) {
            ...
            try {
                ...
                fileNames.add(LeDuoMallUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
            } catch (IOException e) {
                e.printStackTrace();
                return ResultGenerator.genFailResult("文件上传失败");
            }
