...
public class LeDuoMallUserController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(leDuoMallUserService.getNewBeeMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (leDuoMallUserService.lockUsers(ids, lockStatus)) {
